import 'package:chatwith/components/chat_bubble.dart';
  ...
  void initState() {
    ...
    myFocusNode.addListener(() {
      if (myFocusNode.hasFocus) {
        ...
        // then the amount to remaining space will be calculated,
        // then scroll down
        Future.delayed(
    ...
    // wait a bit for listvies to be built , then scroll to bottom
    Future.delayed(
      const Duration(milliseconds: 500),
      () => scrollDown(),
    );
